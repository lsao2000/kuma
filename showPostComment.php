    ...
    <body>
        ...
        <div class="post">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-2 col-md-2">w</div>
        ...
        <!-- <div class="post">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-9 col-md-7 card" id="cardPost">
                        <div class="mt-3" id="comment">
                            <img src="./imgdb/lahcen/profile/ai.jpg" alt="">
                            <div class="paragraph">
                                <h6 class="ms-3 me-2 fw-bold">lahcen</h6>
                                <p>sd dsfd sf fdsd fsd sdf df sff af</p>
                                <span id="date">2023/10/25</span>
                            </div>
                        </div>
                        <div class="mt-3" id="comment">
                            <img src="./imgdb/lahcen/profile/ai.jpg" alt="">
                        ...
                        <div class="mt-3" id="comment">
                            ...
                            <div class="paragraph">
                                <h6 class="ms-3 me-2 fw-bold">lahcen</h6>
                                <p>sd dsfd sf fdsd fsd sdf df ssssssssd    dddfdf df dfds sff af</p>
                                <span id="date">2023/10/25</span>
                            </div>
                        </div>
                        <div class="mt-3" id="comment">
                        ...
                        <div class="mt-3" id="comment">
                            ...
                            <div class="paragraph">
                                <h6 class="ms-3 me-2 fw-bold">lahcen</h6>
                                <p>sd dsfd sf fdsd fsdsdg df dfg fgg sdf df sff af</p>
                                <span id="date">2023/10/25</span>
                            </div>
                        </div>
                        <div class="mt-3" id="comment">
